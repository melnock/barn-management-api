...
Horse.create(stall_id: 1,
  paddock_id: 1,
  tack:{saddle: "Black Custom Saddlery with White Piping", bridle: "Double with rubber reins", saddle_pads: "labeled with LC", special_pads: "lambskin half pad"},
  supplements:{vitamin_e:"5cc", biotin:"2 scoops"},
  blankets: {below_60: {sheet:{color:"navy with green trim"}}, below_40:{sheet:{color:"navy with green trim"}}, below_30:{medium:{color:"navy with grey trim"}}, below_20:{heavy:{color:"grey with green trim"}}},
  name: "Wing Dings",
  birth_year: 1999,
  user_id: 3,
  vet_id: 1,
...
Horse.create(stall_id: 2,
  paddock_id: 2,
  tack:{saddle: "Black Lauriche", bridle: "Snaffle with rubber reins", saddle_pads: "labeled with TD"},
  supplements:{vitamin_e:"5cc", biotin:"2 scoops"},
  blankets: {below_60: {sheet:{color:"purple"}}, below_40:{sheet:{color:"purple"}}, below_30:{medium:{color:"light blue with grey trim"}}, below_20:{heavy:{color:"black"}}},
  name: "Naughty Pony",
  birth_year: 2006,
  user_id: 2,
  vet_id: 1,
